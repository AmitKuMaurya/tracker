...
# Source files
SOURCES = main_file.c login_map.c json_writer.c offline_data.c lbs_latlong.c
OBJECTS = $(SOURCES:%.c=$(OBJ_DIR)/%.o)
TARGET = $(BIN_DIR)/tracker

# Header files
HEADERS = conn.h login_map.h json_writer.h offline_data.h lbs_latlong.h
...
$(OBJ_DIR)/lbs_latlong.o: lbs_latlong.c lbs_latlong.h offline_data.h
